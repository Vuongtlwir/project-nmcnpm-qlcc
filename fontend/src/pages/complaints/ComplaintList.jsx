...
export default function ComplaintList() {
  ...
  const [complaints, setComplaints] = useState([
    { id: "PH-001", title: "Ống nước rò rỉ", date: "28/05/2026", status: "Đang xử lý", category: "Cơ sở vật chất" },
    { id: "PH-002", title: "Trung tâm thang máy chập chờn", date: "22/05/2026", status: "Hoàn thành", category: "An toàn" },
    { id: "PH-003", title: "Phát sinh rác thải không đúng quy định", date: "30/05/2026", status: "Đang xử lý", category: "Vệ sinh" },
  ]);
  ...
  const filteredComplaints = useMemo(
    () => complaints.filter((item) => {
      ...
      return item.title.toLowerCase().includes(keyword) || item.id.toLowerCase().includes(keyword) || item.category.toLowerCase().includes(keyword);
    }),
    [search, complaints]
  );
  ...
  const handleSubmit = (event) => {
    ...
    setFormData({ title: "", category: "Cơ sở vật chất", details: "" });
      ...
      <div className="page-actions" style={{ flexDirection: "column", alignItems: "stretch" }}>
        ...
        <div className="complaint-form page-card" style={{ marginTop: "24px", padding: "20px" }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="search-field">
              <label htmlFor="complaint-category">Loại phản ánh</label>
              <select
